...
//#define DEBUG_PRINT_RUNNING

// -- changables --
static const bool REAL_TIME = true;

static const int BUFFLENGTH = 367;

static const int SYNTH_FRE = 11025;

bool RECORD_SONG = false;

static const unsigned long WAVE_FILE_LENGTH = (4*60+40)*1000; // in ms
static const unsigned long STOP_TIME = 10*(4*60+30)*1000; // in ms

/*
 * ----- In-Ports ----
 * 1 - steinberg-1 : keyboard
 * 2 - steinberg-2 : u-control
 * 3 - steinberg-3 : b-control
 * 4 - steinberg-4 : cakewalk
 */
static const int MIDI_IN_PORT = 3;
static const int MIDI_IN_MIX_PORT = 4;

/*
 * ----- Out-Ports ----
 * 7 - steinberg-3 : b-control
 */
static const int MIDI_OUT_PORT = 7;

//static const char *MIDI_FILE_NAME = "moonlight_shadow_SCS.mid";
//static const char *MIDI_FILE_NAME = "fernando - SCS.mid";
static const char *MIDI_FILE_NAME = "Tecnic_SCS.mid";
//static const char *MIDI_FILE_NAME = "Ukosat8-SCS.mid";
//static const char *MIDI_FILE_NAME = "DURPHI9_SCS.mid";
static const bool USE_MIDI_FILE = false;

static const dup_uint16 N_CHANNELS = 16;

static const bool CHANNEL_SPECIFIC_N_VOICES = false;
static const dup_uint16 N_VOICES = 7;

static int CHANNEL_N_VOICES[] =
{
	5, //channel 1
	5, //channel 2
	5, //channel 3
...
bool USE_DRUM_SAMPLER = false;
char *DRUM_SAMPLES_DESCRITION_FILENAME = "DrumSamplesDescrition.txt";
double DRUM_SAMPLER_SCSP_VOL = 1.0;


char *waveFileName = "out.wav";

//static const double DS_VOLUME = 0.09;
static const double DS_VOLUME = 0.2;
//static const double DS_VOLUME = 0.15;

static const double WAVE_FILE_VOL = 0.15;

//static const bool SHOW_PORTS = false;

static const double BASE_FRE_STEP = 0.75;



//static const double DRUM_SCSP_VOL = 0.5;

static const dup_uint8 KEYBOARD_CHANNEL = 1;

static const bool DOUBLE_KEYBOARD_CHANNELS = false;

static const int TRANSPOSE = 0; // only works with midi messages

// ----------------

static const int LOW_CUT_FRE = 20;

static const double HIGH_CUT_DIVISION = 2.0;

static const dup_uint32 HIGH_CUT_ORDER = 2;

static const int KEYBOARD_2_TRANS = 0;

static const unsigned int SINE_TABLE_SIZE = 1024;

//static const int N_DRUMS = 14;

static const dup_moduleid MIDI_RECEIVER = 5;

static const int DRUM_CHANNEL = 900;

//static const int SAMPLE_RATE = 96000;
static const int SAMPLE_RATE = SYNTH_FRE;
