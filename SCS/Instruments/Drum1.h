...
public:
	...
	bool Run()
	{
		...
		Amp = Amp + Fall2(TimePos*Mod/10) * NoiseMod*0.5*NegSine(Rise2(NegSine(HPos*52.56)*NegSine(HPos*150)*NegSine(HPos*137.8)*NegSine(HPos*95.43)*NegSine(HPos*113.6784)*Tri(HPos*116.9)*8));
